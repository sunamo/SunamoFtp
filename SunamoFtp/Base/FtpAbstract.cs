...
public abstract class FtpAbstract
{
    ...
    /// <summary>
    ///     Pokud bude nastaveno na false, nebude se uploadovat na hosting nic - používá se pouze v této třídě, proto všechno
    ///     ostatní bude fungovat normálně
    /// </summary>
    ...
    public abstract void DeleteRecursively(List<string> slozkyNeuploadovatAVS, string dirName, int i,
